...
def data_pass_name(pos1, pos2, pos3, pos4, quantity, image, theme):
    ...
    subprocess.run("tesseract --psm 6 --tessdata-dir '/home/Warframe-OCR/tessdata' -l Roboto --oem 1 -c tessedit_char_whitelist=ABCDEFGHIKLMNOPQRSTUVWXYZabcdefghiklmnopqrstuvwxyz0123456789 {} {} lstmbox".format(gen_name_ext, gen_name_wo_ext), shell=True)
