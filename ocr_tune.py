...
def data_pass_name(pos1, pos2, pos3, pos4, quantity):
    ...
    tessdata_dir_config = '--tessdata-dir "/home/demokdawa/Warframe-OCR/tessdata" -l roboto --oem 1 -c tessedit_char_whitelist=ABCDEFGHIKLMNOPQRSTUVWXYZabcdefghiklmnopqrstuvwxyz0123456789 get.images'
